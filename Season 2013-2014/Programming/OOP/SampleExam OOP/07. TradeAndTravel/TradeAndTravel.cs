...
namespace TradeAndTravel
{
    ...
    {
        private const int ItemValue = 3;

        public Iron(string name, Location location = null)
            : base(name, Iron.ItemValue, ItemType.Iron, location)
        {
        }
    }
}
...
namespace TradeAndTravel
{
    class NewInteractionManager : InteractionManager
    {
        ...
        {
            var itemName = commandWords[2];
            var allItems = actor.ListInventory();
...
//create location forest whiterun
//create item wood haha whiterun
...
namespace TradeAndTravel
{
    class Program
    {
        ...
        {
            var engine = new Engine(new NewInteractionManager());
            engine.Start();
        }
    }
}
...
namespace TradeAndTravel
{
    public class Weapon : Item
    {
        ...
        public Weapon(string name, Location location = null)
            : base(name, Weapon.ItemValue, ItemType.Weapon, location)
        {
        }
    }
}
...
namespace TradeAndTravel
{
    ...
    {
        private const int ItemValue = 2;

        public Wood(string name, Location location = null)
            : base(name, Wood.ItemValue, ItemType.Wood, location)
        {
        }
